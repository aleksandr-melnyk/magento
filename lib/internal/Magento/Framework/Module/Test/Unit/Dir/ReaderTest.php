...
class ReaderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetModuleDirWhenCustomDirIsNotSet()
    {
        ...
        $this->assertEquals(
            ...
            $this->_model->getModuleDir(Dir::MODULE_ETC_DIR, 'Module')
        );
    }
    ...
    public function testGetModuleDirWhenCustomDirIsSet()
    {
        ...
        $this->_model->setModuleDir('Module', 'etc', $moduleDir);
        $this->assertEquals($moduleDir, $this->_model->getModuleDir(Dir::MODULE_ETC_DIR, 'Module'));
    }
    ...
    public function testGetConfigurationFiles()
    {
        ...
        $this->_moduleListMock->expects($this->once())->method('getNames')->will($this->returnValue(['Module']));
        ...
        $model->setModuleDir('Module', 'etc', 'app/code/Test/Module/etc');
    ...
    public function testGetComposerJsonFiles()
    {
        ...
        $model->setModuleDir('Module', '', 'app/code/Test/Module');
